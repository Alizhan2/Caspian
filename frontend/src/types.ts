...
export interface LabelSample { sample_id: string; scene_id: string; acquisition_time: string; region: string; region_name: string; bbox: number[]; review_status: "unreviewed" | "reviewed_positive" | "reviewed_negative"; reviewed_by?: string | null; reviewed_at?: string | null; polygon_count: number; polygons: number[][][]; preview_url: string; }
